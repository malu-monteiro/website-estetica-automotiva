...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="scroll-mt-36 mt-12 md:mt-24 mb-12 md:mb-24 relative border-b border-neutral-800 min-h-[800px] pb-16"
    >
      <div className="flex flex-col lg:flex-row items-start justify-between max-w-7xl mx-auto px-4 sm:px-8 mt-6 md:mt-20 gap-8 md:gap-12">
        {/* Imagem */}
